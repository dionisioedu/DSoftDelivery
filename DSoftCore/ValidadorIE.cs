...
namespace DSoftCore
{
	public static class ValidadorIE
	{
		#region Methods
		...
		[Obsolete]
		public static bool Validar(string pInscr, string pUF)
		{
			bool retorno = false;
			string strBase;
			string strBase2;
		...
		public static bool ValidarDll(string inscr, string uf)
		{
			return ConsisteInscricaoEstadual(inscr, uf) > 0;
		}
