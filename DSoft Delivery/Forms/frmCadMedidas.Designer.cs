namespace DSoft_Delivery.Forms
{
	partial class frmCadMedidas
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmCadMedidas));
			...
			this.lbErroCodigo = new System.Windows.Forms.Label();
			this.lbErroDescricao = new System.Windows.Forms.Label();
			this.lbErroAbreviatura = new System.Windows.Forms.Label();
			...
			this.tbDescricao.Location = new System.Drawing.Point(12, 86);
			...
			this.tbAbreviatura.Location = new System.Drawing.Point(12, 125);
			this.tbAbreviatura.Name = "tbAbreviatura";
			this.tbAbreviatura.Size = new System.Drawing.Size(100, 20);
			this.tbAbreviatura.TabIndex = 3;
			this.tbAbreviatura.TextChanged += new System.EventHandler(this.tbAbreviatura_TextChanged);
			this.tbAbreviatura.KeyDown += new System.Windows.Forms.KeyEventHandler(this.tbAbreviatura_KeyDown);
			// 
			// btConfirmar
			// 
			...
			this.btConfirmar.Location = new System.Drawing.Point(12, 204);
			...
			this.btSair.Location = new System.Drawing.Point(141, 204);
			...
			this.dataGridView1.Size = new System.Drawing.Size(302, 237);
			...
			// lbErroCodigo
			// 
			this.lbErroCodigo.AutoSize = true;
			this.lbErroCodigo.ForeColor = System.Drawing.Color.Red;
			this.lbErroCodigo.Location = new System.Drawing.Point(118, 50);
			this.lbErroCodigo.Name = "lbErroCodigo";
			this.lbErroCodigo.Size = new System.Drawing.Size(87, 13);
			this.lbErroCodigo.TabIndex = 10;
			this.lbErroCodigo.Text = "*Campo Inválido!";
			this.lbErroCodigo.Visible = false;
			// 
			// lbErroDescricao
			// 
			this.lbErroDescricao.AutoSize = true;
			this.lbErroDescricao.ForeColor = System.Drawing.Color.Red;
			this.lbErroDescricao.Location = new System.Drawing.Point(118, 89);
			this.lbErroDescricao.Name = "lbErroDescricao";
			this.lbErroDescricao.Size = new System.Drawing.Size(87, 13);
			this.lbErroDescricao.TabIndex = 11;
			this.lbErroDescricao.Text = "*Campo Inválido!";
			this.lbErroDescricao.Visible = false;
			// 
			// lbErroAbreviatura
			// 
			this.lbErroAbreviatura.AutoSize = true;
			this.lbErroAbreviatura.ForeColor = System.Drawing.Color.Red;
			this.lbErroAbreviatura.Location = new System.Drawing.Point(118, 128);
			this.lbErroAbreviatura.Name = "lbErroAbreviatura";
			this.lbErroAbreviatura.Size = new System.Drawing.Size(87, 13);
			this.lbErroAbreviatura.TabIndex = 12;
			this.lbErroAbreviatura.Text = "*Campo Inválido!";
			this.lbErroAbreviatura.Visible = false;
			// 
			// frmCadMedidas
			// 
			...
			this.Controls.Add(this.lbErroAbreviatura);
			this.Controls.Add(this.lbErroDescricao);
			this.Controls.Add(this.lbErroCodigo);
			...
			this.Controls.Add(this.tbAbreviatura);
			...
			this.Name = "frmCadMedidas";
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "Cadastro de Medidas";
			this.Load += new System.EventHandler(this.frmCadMedidas_Load);
		...
		private System.Windows.Forms.Label lbErroCodigo;
		private System.Windows.Forms.Label lbErroDescricao;
		private System.Windows.Forms.Label lbErroAbreviatura;
	}
}