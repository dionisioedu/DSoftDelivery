...
{
	public partial class frmNovoItemTerco : Form
	{
		private Bd _dsoftBd;
		...
		public frmNovoItemTerco(Bd bd, Usuario usuario, TabelaDePrecos tabela, List<Produto> produtos, Dictionary<Produto, decimal> precos, long produto = 0)
		{
			InitializeComponent();
		...
		public frmNovoItemTerco(Bd bd, Usuario usuario, TabelaDePrecos tabela, List<ItemPedido> itens)
		{
			InitializeComponent();
		...
		private void frmNovoItemTerco_Load(object sender, EventArgs e)
		{
		...
		private void ComboboxPressed(object sender, EventArgs e, int indice)
		{
			...
			if (comboBox != null)
			{
				...
				Itens[indice].Quantidade = (float)0.33333;
