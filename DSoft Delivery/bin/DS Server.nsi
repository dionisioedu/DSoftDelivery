...
Section "SeçãoPrincipal" SEC01
  ...
  File "C:\DSoft\Ferramentas\postgresql-9.1.18-3-windows.exe"
SectionEnd
...
!define PostgreSqlVersion "9.1"
!define PostgreSqlInstaller "postgresql-9.1.18-3-windows.exe"
Section "PostgreSql ${PostgreSqlVersion}"
        ...
        NSISdl::download http://get.enterprisedb.com/postgresql/postgresql-9.1.18-3-windows.exe ${PostgreSqlInstaller}
        Pop $0
        StrCmp $0 success success
               ...
               Abort
        success:
                ExecWait '${PostgreSqlInstaller} --unattendedmodeui minimal --mode unattended --superpassword "dsoft2008" --servicename "postgreSQL" --servicepassword "dsoft2008" --serverport 5432'
