...
(
  ...
  taxa_servico double precision DEFAULT 0,
...
(
  ...
  nome character varying,
  situacao character(1) DEFAULT 'A'::bpchar,
  cliente_interno boolean NOT NULL DEFAULT false,
  mensalidade boolean DEFAULT false,
...
(
  ...
  vencimento_mensalidade integer,
...
(
  ...
  permite_locacao boolean DEFAULT false,
  intervalo_locacao character varying,
  impressora_externa character varying,
  adicionais boolean NOT NULL DEFAULT false,
  meio boolean NOT NULL DEFAULT false,
  fracao boolean NOT NULL DEFAULT false,
  periodo_locacao integer DEFAULT 0,
  imprime_total boolean DEFAULT false,
...
(
  ...
  capkg character varying,
  capm3 character varying,
  rntrc character varying,
  ie character varying,
...
(
  ...
  boleto double precision DEFAULT 0,
  vr double precision DEFAULT 0,
  venda_direta double precision DEFAULT 0,
  cliente_interno double precision DEFAULT 0,
  cliente_mensalista double precision DEFAULT 0,
...
(
  ...
  situacao character(1) DEFAULT 'A'::bpchar,
  observacao character varying,
  CONSTRAINT locacao_itens_pkey PRIMARY KEY (indice)
)
WITH (
  OIDS=FALSE
);
...
(
  indice serial NOT NULL,
  cliente bigint,
  inicio_data date DEFAULT now(),
  inicio_hora time without time zone DEFAULT now(),
  situacao character(1) DEFAULT 'A'::bpchar,
  previsao_data date,
  previsao_hora time without time zone,
  devolucao_data date,
  devolucao_hora time without time zone,
  usuario_inicio integer,
  usuario_recepcao integer,
  valor_previsto numeric DEFAULT 0,
  valor_real numeric,
  observacao character varying,
  CONSTRAINT locacao_pkey PRIMARY KEY (indice)
)
WITH (
  OIDS=FALSE
);
ALTER TABLE locacao
  ...
  -- Table: usuario_niveis

-- DROP TABLE usuario_niveis;
...
(
  ...
  lancar_pedidos boolean NOT NULL DEFAULT false,
  alterar_pedidos boolean NOT NULL DEFAULT false,
  cancelar_pedidos boolean NOT NULL DEFAULT false,
  caixa boolean NOT NULL DEFAULT false,
  controle_financeiro boolean NOT NULL DEFAULT false,
  entregas boolean NOT NULL DEFAULT false,
  relatorios boolean NOT NULL DEFAULT false,
  cadastrar_produtos boolean NOT NULL DEFAULT false,
  alterar_precos boolean NOT NULL DEFAULT false,
  compras boolean NOT NULL DEFAULT false,
  cadastrar_recursos boolean NOT NULL DEFAULT false,
  cadastrar_usuarios boolean NOT NULL DEFAULT false,
  alterar_estoque boolean NOT NULL DEFAULT false,
  script_bd boolean NOT NULL DEFAULT false,
  preferencias boolean NOT NULL DEFAULT false,
  terminal boolean NOT NULL DEFAULT false,
  regras_negocio boolean NOT NULL DEFAULT false,
  cadastrar_grupos_de_clientes boolean DEFAULT false,
  escritorio boolean DEFAULT false,
  almoxarifado boolean DEFAULT false,
  CONSTRAINT usuario_niveis_pkey PRIMARY KEY (nivel)
)
WITH (
  OIDS=FALSE
);
ALTER TABLE usuario_niveis
  ...
  -- Table: regras_negocios

-- DROP TABLE regras_negocios;

CREATE TABLE regras_negocios
(
...
ALTER TABLE regras_negocios
  OWNER TO dsoft;


  -- Table: calendario_tabelas

-- DROP TABLE calendario_tabelas;

CREATE TABLE calendario_tabelas
(
...
ALTER TABLE calendario_tabelas
  OWNER TO dsoft;


  -- Table: cad_adicionais

-- DROP TABLE cad_adicionais;
...
ALTER TABLE cad_adicionais
  OWNER TO postgres;

  
  -- Table: cad_observacoes

-- DROP TABLE cad_observacoes;

CREATE TABLE cad_observacoes
(
  observacao character varying,
  ordem integer
)
