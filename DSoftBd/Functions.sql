...
-- Function: dsoft_altera_fornecedor(bigint, integer, character varying, character varying, integer, integer, character varying, character varying, character varying, character varying, character varying, integer, character varying, character, character varying)

-- DROP FUNCTION dsoft_altera_fornecedor(bigint, integer, character varying, character varying, integer, integer, character varying, character varying, character varying, character varying, character varying, integer, character varying, character, character varying);

CREATE OR REPLACE FUNCTION dsoft_altera_fornecedor(p_usuario bigint, p_codigo integer, p_nome character varying, p_cnpj character varying, p_tel1 integer, p_tel2 integer, p_endereco character varying, p_bairro character varying, p_cidade character varying, p_estado character varying, p_pais character varying, p_cep integer, p_contato character varying, p_tipo character, p_obs character varying)
  RETURNS character varying AS
$BODY$
declare USUARIO_INVALIDO		varchar := 'ERRO_00';
declare USUARIO_BLOQUEADO		varchar := 'ERRO_03';
...
begin
    ...
    auxiliar := situacao from cad_fornecedores where codigo = p_codigo;
    
    if (auxiliar is null) then
    	return CODIGO_NAO_ENCONTRADO;
    end if;
    
    update cad_fornecedores set nome = p_nome,
                                  cnpj = p_cnpj,
                                  tel1 = p_tel1,
                                  tel2 = p_tel2,
                                  endereco = p_endereco,
...
$BODY$
  LANGUAGE plpgsql VOLATILE
  COST 100;
ALTER FUNCTION dsoft_altera_fornecedor(bigint, integer, character varying, character varying, integer, integer, character varying, character varying, character varying, character varying, character varying, integer, character varying, character, character varying)
  OWNER TO postgres;
...
CREATE OR REPLACE FUNCTION dsoft_altera_tabela(cod_tabela integer, nome_tabela character varying, descr_tabela character varying, usuario integer)
  RETURNS character varying AS
$BODY$
declare CODIGO_INVALIDO			varchar := 'ERRO_05';
...
begin
    ...
    auxiliar := nome from cad_usuarios where codigo = usuario limit 1;
...
begin
	...
	n_vendas := sum(total) from pedidos where situacao <> 'C' and fechamento is null;
	n_volume := count(indice) from pedidos where situacao <> 'C' and fechamento is null;
...
-- Function: dsoft_novo_fornecedor(integer, bigint, character varying, character varying, integer, integer, character varying, character varying, character varying, character varying, character varying, integer, character varying, character, character varying)

-- DROP FUNCTION dsoft_novo_fornecedor(integer, bigint, character varying, character varying, integer, integer, character varying, character varying, character varying, character varying, character varying, integer, character varying, character, character varying);

CREATE OR REPLACE FUNCTION dsoft_novo_fornecedor(p_usuario integer, p_codigo bigint, p_nome character varying, p_cnpj character varying, p_tel1 integer, p_tel2 integer, p_endereco character varying, p_bairro character varying, p_cidade character varying, p_estado character varying, p_pais character varying, p_cep integer, p_contato character varying, p_tipo character, p_obs character varying)
  RETURNS character varying AS
$BODY$
declare USUARIO_INVALIDO		varchar := 'ERRO_00';
declare USUARIO_BLOQUEADO		varchar := 'ERRO_03';
...
begin
    ...
    insert into cad_fornecedores (codigo,
    								nome,
                                    cnpj,
                                    tel1,
                                    tel2,
...
$BODY$
  LANGUAGE plpgsql VOLATILE
  COST 100;
ALTER FUNCTION dsoft_novo_fornecedor(integer, bigint, character varying, character varying, integer, integer, character varying, character varying, character varying, character varying, character varying, integer, character varying, character, character varying)
  OWNER TO postgres;
